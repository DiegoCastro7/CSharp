-- Creacion de estructura y vinculacion
CREATE TABLE pais(
...
--Editar estructura ya creada
--Se vincula una nueva FK
...
SELECT id,nombre 
FROM pais;
--Elementos unicos para que no se repitan
ALTER TABLE pais 
...
--Clausulas y operadores para seleccion y consulta de Data
CLAUSULAS
...
--Actualizacion de Data ya creada
---------------------------------------------------------
